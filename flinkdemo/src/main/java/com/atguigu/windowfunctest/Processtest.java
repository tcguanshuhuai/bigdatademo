...
public class Processtest {
    public static void main(String[] args) throws Exception {
        ...
        URL url = Processtest.class.getClassLoader().getResource("input/words4.txt");
        ...
        source.map(x -> {
                ...
                //进行avg计算
                .process(new ProcessWindowFunction<Tuple3<String, Long, Integer>, Tuple2<String, Integer>, String, TimeWindow>() {
                    @Override
                    public void process(String key, Context context, Iterable<Tuple3<String, Long, Integer>> input, Collector<Tuple2<String, Integer>> out) throws Exception {
                        int sum = 0;
                        int count =0;
